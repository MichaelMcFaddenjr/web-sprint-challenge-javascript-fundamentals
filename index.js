...
//The nested function is able to access the variable internal because the nested function is located inside of myFunction's lexical scope.
...
const zooAnimals = [
 ...
 function animalNames(array){
  let habitatDisplay = [];
  function displayNames(animal){
    habitatDisplay.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`)
  }
  array.forEach(displayNames);
 ...
 function USApop(array){
  return array.reduce(function(accumulator, animals){
